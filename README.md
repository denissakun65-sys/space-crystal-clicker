...
- 👍 **Реакции** на сообщения, ✉ **личные сообщения**, 🎁 **подарки кристаллов**
- 👥 **Профили игроков** (клик по нику), команды чата `/w` и `/gift`
- ✨ **Перерождение (престиж)** и 😴 **офлайн-доход** — у игры есть цель
- 📋 **Система заданий (квесты)** — ежедневные и еженедельные цели с наградами
- 🔐 **Регистрация и вход** — локальный аккаунт (без Firebase) + Google/GitHub OAuth при подключении
- 📝 **Страница «Версии»** — встроенный changelog в игре
- 💎 **Глобальный индикатор баланса**, видимый на всех страницах
...
По вопросам, багам и предложениям пишите на почту: **imrealzproject@gmail.com**
(кнопка «📬 Вопросы по сайту» есть и в самой игре, в разделе «Сеть»).

---

## 👥 Взаимодействие игроков

В чате и списках игроков доступно живое взаимодействие (в реальном режиме — между игроками;
в демо-режиме — с ботами):

| Действие | Как |
|----------|-----|
| Реакция на сообщение | Наведите на сообщение → выберите эмодзи (👍 ❤️ 😂 🔥 🎉 💎) |
| Профиль игрока | Клик по нику в чате, лидерборде или списке онлайна |
| Личное сообщение | `/w <ник> <текст>` |
| Подарок кристаллов | `/gift <ник> <сумма>` или кнопка «Подарить» в профиле |
